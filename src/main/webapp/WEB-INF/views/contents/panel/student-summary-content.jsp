...
<jsp:useBean id="target" scope="request" type="fr.cyu.coffeeclasses.spring.model.user.Student" />
...
<div class="box">
    ...
    <form action="${pageContext.request.contextPath}/panel/student/details" method="post" style="margin-top: 20px;">
        <button type="submit" class="btn-custom">Télécharger les notes en PDF</button>
    </form>
</div>
